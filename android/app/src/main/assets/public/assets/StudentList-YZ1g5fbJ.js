import { a as reactExports, j as jsxRuntimeExports, n as User, Z as Zap, M as Monitor, c as clsx, p as Search, bB as MessageSquare } from "./index-l2RTGEA9.js";
...
const StudentList = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-80 lg:w-96 flex flex-col glass-panel overflow-hidden h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b border-[var(--md-sys-color-outline)] bg-[var(--md-sys-color-surface)]/50 backdrop-blur-md sticky top-0 z-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)]/40 p-1.5 rounded-2xl mb-3 border border-[var(--md-sys-color-outline)]/40 backdrop-blur-sm", children: ["All", "Solar", "ICT"].map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
