...
const STUDENT_GROUPS = ["Academy", "CBC", "High School", "Campus"];
const getLevelsForGroup = (group) => {
  return EDUCATION_LEVELS[group] || EDUCATION_LEVELS["Academy"];
};
const getDefaultLevel = (group) => {
  var _a;
...
export {
  ...
  getLevelsForGroup as b,
  getLevelShortLabel as g
};
