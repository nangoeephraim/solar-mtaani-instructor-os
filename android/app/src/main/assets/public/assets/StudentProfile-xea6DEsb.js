const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StudentList-YZ1g5fbJ.js","assets/index-l2RTGEA9.js","assets/index-CbivJHeu.css","assets/phone-CqfxTuVm.js","assets/ProfileHeader-DrsZS-fQ.js","assets/educationLevels-CHjJC3HX.js","assets/notificationService-BeqD9muY.js","assets/bell-uYPXG9t7.js","assets/pen-line-H3epL2V1.js","assets/trash-2-Yv5HQ1Ge.js","assets/trending-down-1cr5Bw5-.js","assets/OverviewTab-Cz28jEz3.js","assets/map-pin-8netVHeZ.js","assets/AnalyticsTab-NbhI7y2v.js","assets/AttendanceTab-BS8tmcDM.js","assets/plus-DtGTZnOX.js","assets/circle-alert-CMgkxloe.js","assets/BillingTab-C0SIHato.js","assets/credit-card-DLKrQcd_.js","assets/smartphone-D9wRS1Hu.js","assets/history-BUjqAZuU.js"])))=>i.map(i=>d[i]);
import { a as reactExports, j as jsxRuntimeExports, l as UserPlus, X, c as clsx, d as useToast, R as React, P as PageTransition, G as GraduationCap, n as User, B as BookOpen, F as FileText, T as TriangleAlert, _ as __vitePreload } from "./index-l2RTGEA9.js";
import { s as studentSchema, v as validateWithSchema, E as EditStudentModal } from "./EditStudentModal-DTzr_TUC.js";
import { S as STUDENT_GROUPS, a as getDefaultLevel, b as getLevelsForGroup } from "./educationLevels-CHjJC3HX.js";
import { C as CircleAlert } from "./circle-alert-CMgkxloe.js";
import { P as Plus } from "./plus-DtGTZnOX.js";
import { A as ArrowLeft } from "./arrow-left-DdTxxQg4.js";
import { C as CreditCard } from "./credit-card-DLKrQcd_.js";
import "./camera-BDD2Ner5.js";
import "./save-CIv_kv6h.js";
const AddStudentModal = ({ isOpen, onClose, onAdd }) => {
  const [name, setName] = reactExports.useState("");
  const [grade, setGrade] = reactExports.useState("L3");
  const [lot, setLot] = reactExports.useState("2025");
  const [subject, setSubject] = reactExports.useState("Solar");
  ...
  const getDefaultCompetencies = (subject2) => {
    if (subject2 === "Solar") {
  ...
  reactExports.useCallback((field, value) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--md-sys-color-surface)] rounded-2xl shadow-2xl w-full max-w-md animate-fade-in overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "p-6 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase tracking-wider block mb-2", children: "Program / Trade *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)] rounded-xl p-1", children: ["Solar", "ICT"].map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            className: clsx(
              ...
              subject === sub ? "bg-[var(--md-sys-color-primary)] text-[var(--md-sys-color-on-primary)] shadow" : "text-[var(--md-sys-color-secondary)] hover:text-[var(--md-sys-color-on-surface)]"
            ),
            children: sub
          },
          sub
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase tracking-wider block mb-2", children: "Student Group" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)] rounded-xl p-1", children: STUDENT_GROUPS.map((grp) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => {
              setStudentGroup(grp);
              setGrade(getDefaultLevel(grp));
            },
            className: clsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase tracking-wider block mb-2", children: "Education Level" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              value: grade,
              ...
              children: getLevelsForGroup(studentGroup).map((lvl) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: lvl.id, children: lvl.label }, lvl.id))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase tracking-wider block mb-2", children: "Lot / Cohort" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              value: lot,
              ...
              className: "w-full px-4 py-3 bg-[var(--md-sys-color-surface-variant)] border border-[var(--md-sys-color-outline)] rounded-xl text-sm font-semibold text-[var(--md-sys-color-on-surface)] focus:outline-none focus:ring-2 focus:ring-[var(--md-sys-color-primary)]",
              children: ["2024", "2025", "2026"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: l, children: l }, l))
            }
          )
        ] })
      ] }),
...
const StudentList = reactExports.lazy(() => __vitePreload(() => import("./StudentList-YZ1g5fbJ.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0).then((module) => ({ default: module.StudentList })));
const ProfileHeader = reactExports.lazy(() => __vitePreload(() => import("./ProfileHeader-DrsZS-fQ.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8,9,10]) : void 0).then((module) => ({ default: module.ProfileHeader })));
const OverviewTab = reactExports.lazy(() => __vitePreload(() => import("./OverviewTab-Cz28jEz3.js"), true ? __vite__mapDeps([11,1,2,3,12]) : void 0).then((module) => ({ default: module.OverviewTab })));
const AnalyticsTab = reactExports.lazy(() => __vitePreload(() => import("./AnalyticsTab-NbhI7y2v.js"), true ? __vite__mapDeps([13,1,2]) : void 0).then((module) => ({ default: module.AnalyticsTab })));
const AttendanceTab = reactExports.lazy(() => __vitePreload(() => import("./AttendanceTab-BS8tmcDM.js"), true ? __vite__mapDeps([14,1,2,15,16]) : void 0).then((module) => ({ default: module.AttendanceTab })));
const BillingTab = reactExports.lazy(() => __vitePreload(() => import("./BillingTab-C0SIHato.js"), true ? __vite__mapDeps([17,1,2,18,19,20]) : void 0).then((module) => ({ default: module.BillingTab })));
