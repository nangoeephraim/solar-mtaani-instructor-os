const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StudentList-D9YMp1hH.js","assets/index-DIO7q2un.js","assets/index-DDAnmZh1.css","assets/subjectUtils-CWZOIqn8.js","assets/phone-DD6dEIde.js","assets/ProfileHeader-C8QOuVu9.js","assets/educationLevels-CWONNkiO.js","assets/notificationService-CdQIZLa7.js","assets/bell-Bdr9qTTq.js","assets/pen-line-D1__iSQq.js","assets/trash-2-k1bm3wyY.js","assets/trending-down-BUR4UCux.js","assets/OverviewTab-sjujhOL0.js","assets/map-pin-7z5cwOR1.js","assets/AnalyticsTab-gpG70SGT.js","assets/AttendanceTab-2tsp_duV.js","assets/plus-BxbIGg63.js","assets/circle-alert-aZa_aZh_.js","assets/BillingTab-Djet4ggY.js","assets/credit-card-CkFSZ0pS.js","assets/smartphone-DmGG-BYM.js","assets/history-CZsOS-Ve.js"])))=>i.map(i=>d[i]);
import { a as reactExports, e as useToast, R as React, j as jsxRuntimeExports, P as PageTransition, G as GraduationCap, c as clsx, n as User, B as BookOpen, F as FileText, T as TriangleAlert, _ as __vitePreload } from "./index-DIO7q2un.js";
import { A as AddStudentModal, E as EditStudentModal } from "./AddStudentModal-D4L3XB8A.js";
import { P as Plus } from "./plus-BxbIGg63.js";
import { A as ArrowLeft } from "./arrow-left-Djm8U2tr.js";
import { C as CreditCard } from "./credit-card-CkFSZ0pS.js";
import "./educationLevels-CWONNkiO.js";
import "./circle-alert-aZa_aZh_.js";
import "./camera-Brsczw5i.js";
import "./save-CeZEp0q1.js";
const StudentList = reactExports.lazy(() => __vitePreload(() => import("./StudentList-D9YMp1hH.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0).then((module) => ({ default: module.StudentList })));
const ProfileHeader = reactExports.lazy(() => __vitePreload(() => import("./ProfileHeader-C8QOuVu9.js"), true ? __vite__mapDeps([5,1,2,6,7,8,3,9,10,11]) : void 0).then((module) => ({ default: module.ProfileHeader })));
const OverviewTab = reactExports.lazy(() => __vitePreload(() => import("./OverviewTab-sjujhOL0.js"), true ? __vite__mapDeps([12,1,2,4,13]) : void 0).then((module) => ({ default: module.OverviewTab })));
const AnalyticsTab = reactExports.lazy(() => __vitePreload(() => import("./AnalyticsTab-gpG70SGT.js"), true ? __vite__mapDeps([14,1,2]) : void 0).then((module) => ({ default: module.AnalyticsTab })));
const AttendanceTab = reactExports.lazy(() => __vitePreload(() => import("./AttendanceTab-2tsp_duV.js"), true ? __vite__mapDeps([15,1,2,16,17]) : void 0).then((module) => ({ default: module.AttendanceTab })));
const BillingTab = reactExports.lazy(() => __vitePreload(() => import("./BillingTab-Djet4ggY.js"), true ? __vite__mapDeps([18,1,2,19,20,21]) : void 0).then((module) => ({ default: module.BillingTab })));
