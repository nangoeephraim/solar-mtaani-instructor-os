const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/reportCardService-Colj8EVL.js","assets/jspdf.es.min-DwYYoiOo.js","assets/index-CxG9nk1k.js","assets/index-CJ5TCxwm.css"])))=>i.map(i=>d[i]);
import { o as createLucideIcon, u as useTheme, a as reactExports, e as useToast, j as jsxRuntimeExports, a3 as Award, h as CircleCheck, c as clsx, _ as __vitePreload, g as ChevronRight, G as GraduationCap, m as motion, B as BookOpen, A as AnimatePresence, X } from "./index-CxG9nk1k.js";
              ...
              "button",
              {
                onClick: async () => {
                  const { generateBulkReportCards } = await __vitePreload(async () => {
                    const { generateBulkReportCards: generateBulkReportCards2 } = await import("./reportCardService-Colj8EVL.js");
              ...
              "button",
              {
                onClick: async () => {
                  const { generateReportCard } = await __vitePreload(async () => {
                    const { generateReportCard: generateReportCard2 } = await import("./reportCardService-Colj8EVL.js");
