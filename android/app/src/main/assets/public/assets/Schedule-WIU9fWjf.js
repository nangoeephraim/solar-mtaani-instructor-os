...
import { C as ChevronLeft } from "./chevron-left-D54ot3_q.js";
...
import { C as Copy } from "./copy-sKvbRN-L.js";
...
Proceed anyway?`,
  ...
  const getSlotColor = (slot) => {
    ...
    if (sub === "Solar") return CLASS_COLORS[4];
    if (sub === "ICT") return CLASS_COLORS[3];
    let hash = 0;
