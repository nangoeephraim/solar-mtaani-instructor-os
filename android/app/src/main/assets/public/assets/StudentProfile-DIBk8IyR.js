const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StudentList-6gyXw-HT.js","assets/index-Dt5N_hgV.js","assets/index-C4y5DRbr.css","assets/phone-SgM2pFxs.js","assets/ProfileHeader-D8aEJVlH.js","assets/educationLevels-X5jx7clp.js","assets/notificationService-C1vNcVmM.js","assets/bell-CqZECojY.js","assets/pen-line-CHVA0GJl.js","assets/trash-2-BGjWgmho.js","assets/trending-down-91xSBhXI.js","assets/OverviewTab-CIbopkMr.js","assets/map-pin-glDEx3Rk.js","assets/AnalyticsTab-C8TNUUf3.js","assets/AttendanceTab-BfRPlLNq.js","assets/plus-Bc3jfd83.js","assets/circle-alert-BAyhKf4O.js","assets/BillingTab-CzPlbsgl.js","assets/credit-card-7vy04wmO.js","assets/smartphone-CAC5Egj9.js","assets/history-RNDDhpBZ.js"])))=>i.map(i=>d[i]);
import { a as reactExports, e as useToast, R as React, j as jsxRuntimeExports, P as PageTransition, G as GraduationCap, c as clsx, n as User, B as BookOpen, F as FileText, T as TriangleAlert, _ as __vitePreload } from "./index-Dt5N_hgV.js";
import { A as AddStudentModal, E as EditStudentModal } from "./AddStudentModal-BqxbXEBP.js";
import { P as Plus } from "./plus-Bc3jfd83.js";
import { A as ArrowLeft } from "./arrow-left-Dn-Wu7i4.js";
import { C as CreditCard } from "./credit-card-7vy04wmO.js";
import "./educationLevels-X5jx7clp.js";
import "./circle-alert-BAyhKf4O.js";
import "./camera-CpRq3ZQW.js";
import "./save-dAl3Gt98.js";
const StudentList = reactExports.lazy(() => __vitePreload(() => import("./StudentList-6gyXw-HT.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0).then((module) => ({ default: module.StudentList })));
const ProfileHeader = reactExports.lazy(() => __vitePreload(() => import("./ProfileHeader-D8aEJVlH.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8,9,10]) : void 0).then((module) => ({ default: module.ProfileHeader })));
const OverviewTab = reactExports.lazy(() => __vitePreload(() => import("./OverviewTab-CIbopkMr.js"), true ? __vite__mapDeps([11,1,2,3,12]) : void 0).then((module) => ({ default: module.OverviewTab })));
const AnalyticsTab = reactExports.lazy(() => __vitePreload(() => import("./AnalyticsTab-C8TNUUf3.js"), true ? __vite__mapDeps([13,1,2]) : void 0).then((module) => ({ default: module.AnalyticsTab })));
const AttendanceTab = reactExports.lazy(() => __vitePreload(() => import("./AttendanceTab-BfRPlLNq.js"), true ? __vite__mapDeps([14,1,2,15,16]) : void 0).then((module) => ({ default: module.AttendanceTab })));
const BillingTab = reactExports.lazy(() => __vitePreload(() => import("./BillingTab-CzPlbsgl.js"), true ? __vite__mapDeps([17,1,2,18,19,20]) : void 0).then((module) => ({ default: module.BillingTab })));
