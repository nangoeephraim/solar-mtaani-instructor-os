...
import { Box, Trash2, Plus, Monitor, Layout, MapPin, Users, CheckCircle, AlertCircle, Wrench, Filter, X, Edit3, Calendar, History, FileText, Clock, Search, ChevronRight, Link2, BookOpen } from 'lucide-react';
                ...
                <div className="flex mt-6 gap-6">
                    ...
                    >
                        <div className="flex items-center gap-2">
                            <Box size={16} /> Physical Resources
                        </div>
                    </button>
                    <button
