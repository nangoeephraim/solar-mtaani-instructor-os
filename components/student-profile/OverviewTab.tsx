    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-fade-in relative z-10">
            ...
            <div className="lg:col-span-5 space-y-6">
                {/* Contact Details */}
                <div className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:shadow-md transition-all duration-300">
                    ...
                    <div className="space-y-4">
                        <div className="group/item flex items-center gap-4 p-3 hover:bg-[var(--md-sys-color-surface-variant)]/40 rounded-xl transition-all duration-300 cursor-default hover:translate-x-1 border border-transparent hover:border-[var(--md-sys-color-outline)]/40">
                ...
                <div className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:shadow-md transition-all duration-300">
                    ...
                    <div className="p-5 rounded-2xl border border-[var(--md-sys-color-outline)]/50 space-y-4 bg-[var(--md-sys-color-surface-variant)]/20 backdrop-blur-sm">
                        <div>
                    ...
                    <div className="mt-4 flex items-center justify-between p-4 bg-[var(--md-sys-color-surface-variant)]/20 rounded-xl border border-[var(--md-sys-color-outline)]/40 hover:bg-[var(--md-sys-color-surface-variant)]/40 transition-colors duration-350">
            ...
            <div className="lg:col-span-7 space-y-6">
                ...
                <div className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:shadow-md transition-all duration-300">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="glass-card p-4 rounded-2xl border border-[var(--md-sys-color-outline)]/60 relative overflow-hidden group hover:scale-[1.02] hover:-translate-y-0.5 duration-350">
                        ...
                        <div className="glass-card p-4 rounded-2xl border border-[var(--md-sys-color-outline)]/60 relative overflow-hidden group hover:scale-[1.02] hover:-translate-y-0.5 duration-350">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                <span className={clsx(
                                    ...
                                    (student.epraLicenseStatus === 'T1' || student.epraLicenseStatus === 'T2' || student.epraLicenseStatus === 'T3') ? 'bg-emerald-500' :
                                        student.epraLicenseStatus === 'None' ? 'bg-slate-300' : 'bg-slate-300'
                                )} />
                ...
                <div className="glass-panel p-6 rounded-2xl bg-gradient-to-br from-[var(--md-sys-color-surface)] to-indigo-50/30 dark:to-indigo-500/5 relative overflow-hidden group hover:shadow-md transition-all duration-300">
                    ...
                    <div className="flex items-center gap-4 bg-white/50 dark:bg-slate-800/50 p-4 rounded-xl border border-white/40 dark:border-slate-700/50 backdrop-blur-sm">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/20 group-hover:scale-105 transition-transform duration-300">
                            <Award size={24} />
                        </div>
                        <div>
