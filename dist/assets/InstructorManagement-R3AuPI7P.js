import { o as createLucideIcon, a9 as supabase, a as reactExports, e as useToast, j as jsxRuntimeExports, m as motion, U as Users, bW as WordRotator, c as clsx, B as BookOpen, b6 as UserCheck, G as GraduationCap, A as AnimatePresence, X } from "./index-Dt5N_hgV.js";
import { c as getLevelsForGroup, S as STUDENT_GROUPS } from "./educationLevels-X5jx7clp.js";
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 relative z-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)]/60 rounded-xl p-1 border border-[var(--md-sys-color-outline)]", children: ["Solar", "ICT"].map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface-variant)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "select",
                    {
                      ...
                      children: STUDENT_GROUPS.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: g, className: "bg-[var(--md-sys-color-surface)] text-[var(--md-sys-color-on-surface)]", children: g }, g))
                    }
                  ) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
