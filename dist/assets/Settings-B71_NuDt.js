import { o as createLucideIcon, u as useAuth, a as reactExports, d as useToast, a7 as supabase, j as jsxRuntimeExports, m as motion, a8 as Shield, X, U as Users, c as clsx, W as Activity, p as Search, e as RefreshCw, a9 as LoaderCircle, A as AnimatePresence, L as CircleCheckBig, aa as useTheme, S as Settings$1, n as User, F as FileText, f as ChevronRight, ab as Sun, ac as Moon, h as Sparkles, R as React, T as TriangleAlert, Z as Zap, ad as exportDataAsCSV, ae as exportFullBackup, af as importFullBackup, ag as resetData } from "./index-l2RTGEA9.js";
import { P as PageHeader } from "./PageHeader-BNW_nxzr.js";
import { f as fetchProfile, U as UserAvatar, P as Palette, u as uploadProfileAvatar, r as removeProfileAvatar, a as updateProfile } from "./profileService-lGHdKyl9.js";
...
import { F as FileDown } from "./file-down-Dyc4J2Tm.js";
import { D as Download } from "./download-BKGjE_l5.js";
import { U as Upload } from "./cloudStorageService-CCurv7GV.js";
/**
...
const Settings = ({ onDataReset }) => {
  ...
  const handleImportBackup = (e) => {
    ...
    reader.onload = async (event) => {
      var _a2;
      const success = await importFullBackup((_a2 = event.target) == null ? void 0 : _a2.result);
      if (success) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto pb-24 space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "glass-panel rounded-3xl overflow-hidden animate-fade-in", custom: 2.5, initial: "hidden", animate: "visible", variants: cardVariant, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 18 }), title: "Solar Mtaani Workspace", iconColor: "text-emerald-500", badge: "Custom" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-5 pt-1 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-[var(--md-sys-color-on-surface-variant)] leading-relaxed", children: "Configure workspace localization, settlement centers, and default filters custom to your teaching branch." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-bold text-[var(--md-sys-color-on-surface-variant)] uppercase tracking-widest block mb-2 px-1", children: "Training Center / Branch" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-bold text-[var(--md-sys-color-on-surface-variant)] uppercase tracking-widest block mb-2 px-1", children: "Default Subject Focus" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: [
              { id: "All", label: "All Subjects" },
              { id: "Solar", label: "Solar Energy" },
              { id: "ICT", label: "ICT & Digital" }
            ].map((sub) => {
              const isSelected = preferences.defaultSubject === sub.id || sub.id === "All" && !preferences.defaultSubject;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => setPreference("defaultSubject", sub.id),
                  className: clsx(
                    "py-2 px-3 rounded-xl border text-xs font-bold font-google transition-all tap-target-premium cursor-pointer",
                    isSelected ? "border-[var(--accent-primary)] bg-[var(--md-sys-color-primary-container)] text-[var(--md-sys-color-primary)] font-black animate-scale-in" : "border-transparent bg-[var(--md-sys-color-surface-variant)] text-[var(--md-sys-color-on-surface-variant)] hover:bg-[var(--md-sys-color-surface-1)]"
                  ),
