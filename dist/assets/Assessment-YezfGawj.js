const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/reportCardService-Di1y2mAh.js","assets/jspdf.es.min-CKAMaauE.js","assets/index-CWZOk6sM.js","assets/index-DDAnmZh1.css"])))=>i.map(i=>d[i]);
import { o as createLucideIcon, u as useTheme, a as reactExports, e as useToast, j as jsxRuntimeExports, a3 as Award, h as CircleCheck, c as clsx, _ as __vitePreload, g as ChevronRight, G as GraduationCap, m as motion, B as BookOpen, A as AnimatePresence, X } from "./index-CWZOk6sM.js";
              ...
              "button",
              {
                onClick: async () => {
                  const { generateBulkReportCards } = await __vitePreload(async () => {
                    const { generateBulkReportCards: generateBulkReportCards2 } = await import("./reportCardService-Di1y2mAh.js");
              ...
              "button",
              {
                onClick: async () => {
                  const { generateReportCard } = await __vitePreload(async () => {
                    const { generateReportCard: generateReportCard2 } = await import("./reportCardService-Di1y2mAh.js");
