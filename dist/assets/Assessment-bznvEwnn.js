const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/reportCardService-D_jMF6ss.js","assets/jspdf.es.min-op3uTeDl.js","assets/index-l2RTGEA9.js","assets/index-CbivJHeu.css"])))=>i.map(i=>d[i]);
import { o as createLucideIcon, a as reactExports, d as useToast, j as jsxRuntimeExports, a1 as Award, g as CircleCheck, c as clsx, _ as __vitePreload, f as ChevronRight, G as GraduationCap, m as motion, B as BookOpen, A as AnimatePresence, X } from "./index-l2RTGEA9.js";
...
const Assessment = ({ data, onUpdateStudent }) => {
  var _a;
  const [selectedGrade, setSelectedGrade] = reactExports.useState("L3");
  const [selectedGroup, setSelectedGroup] = reactExports.useState("Academy");
  const [selectedSubject, setSelectedSubject] = reactExports.useState("Solar");
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-3 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-panel p-5 rounded-[28px] shadow-elevation-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)]/60 border border-[var(--md-sys-color-outline-variant)] rounded-xl p-1", children: ["Solar", "ICT"].map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)]/60 border border-[var(--md-sys-color-outline-variant)] rounded-xl p-1 overflow-x-auto custom-scrollbar", children: STUDENT_GROUPS.map((grp) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => {
                  setSelectedGroup(grp);
                  setSelectedGrade(getDefaultLevel(grp));
                  setSelectedStudentId(null);
                },
                className: clsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)]/60 border border-[var(--md-sys-color-outline-variant)] rounded-xl p-1 overflow-x-auto custom-scrollbar", children: getLevelsForGroup(selectedGroup).map((lvl) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => {
              ...
              "button",
              {
                onClick: async () => {
                  const { generateBulkReportCards } = await __vitePreload(async () => {
                    const { generateBulkReportCards: generateBulkReportCards2 } = await import("./reportCardService-D_jMF6ss.js");
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 mt-2 text-sm text-[var(--md-sys-color-on-surface-variant)]", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
                ...
                " ",
                selectedStudent.nitaNumber || "No NITA Reg"
              ] })
            ] })
          ] }),
              ...
              "button",
              {
                onClick: async () => {
                  const { generateReportCard } = await __vitePreload(async () => {
                    const { generateReportCard: generateReportCard2 } = await import("./reportCardService-D_jMF6ss.js");
            ...
            (() => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mt-6", children: [
                  ...
                  currentComp.outcomes.map((outcome, idx) => {
