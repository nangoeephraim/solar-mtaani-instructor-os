const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StudentList-BRwNd_dW.js","assets/index-CxG9nk1k.js","assets/index-CJ5TCxwm.css","assets/subjectUtils-CWZOIqn8.js","assets/phone-C2rgmxL9.js","assets/ProfileHeader-BGlB953B.js","assets/educationLevels-CWONNkiO.js","assets/notificationService-Dj8huEY_.js","assets/bell-CZpdIvaV.js","assets/pen-line-BmKqEmHM.js","assets/trash-2-CjyS_af4.js","assets/trending-down--GFbyEGE.js","assets/OverviewTab-Dr0AwHog.js","assets/map-pin-Rcqw39S9.js","assets/AnalyticsTab-gQMEuXf3.js","assets/AttendanceTab-B1vAJLaK.js","assets/plus-CwAYQG3c.js","assets/circle-alert-COyGYATf.js","assets/BillingTab-CU47MQdQ.js","assets/credit-card-DQFnHsJ-.js","assets/smartphone-_krV2azH.js","assets/history-B4j6tY_i.js"])))=>i.map(i=>d[i]);
import { a as reactExports, e as useToast, R as React, j as jsxRuntimeExports, P as PageTransition, G as GraduationCap, c as clsx, n as User, B as BookOpen, F as FileText, T as TriangleAlert, _ as __vitePreload } from "./index-CxG9nk1k.js";
import { A as AddStudentModal, E as EditStudentModal } from "./AddStudentModal-CVIi-wOl.js";
import { P as Plus } from "./plus-CwAYQG3c.js";
import { A as ArrowLeft } from "./arrow-left-CXaEgOiH.js";
import { C as CreditCard } from "./credit-card-DQFnHsJ-.js";
import "./educationLevels-CWONNkiO.js";
import "./circle-alert-COyGYATf.js";
import "./camera-C9IE_GF0.js";
import "./save-Nx_IvaEy.js";
const StudentList = reactExports.lazy(() => __vitePreload(() => import("./StudentList-BRwNd_dW.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0).then((module) => ({ default: module.StudentList })));
const ProfileHeader = reactExports.lazy(() => __vitePreload(() => import("./ProfileHeader-BGlB953B.js"), true ? __vite__mapDeps([5,1,2,6,7,8,3,9,10,11]) : void 0).then((module) => ({ default: module.ProfileHeader })));
const OverviewTab = reactExports.lazy(() => __vitePreload(() => import("./OverviewTab-Dr0AwHog.js"), true ? __vite__mapDeps([12,1,2,4,13]) : void 0).then((module) => ({ default: module.OverviewTab })));
const AnalyticsTab = reactExports.lazy(() => __vitePreload(() => import("./AnalyticsTab-gQMEuXf3.js"), true ? __vite__mapDeps([14,1,2]) : void 0).then((module) => ({ default: module.AnalyticsTab })));
const AttendanceTab = reactExports.lazy(() => __vitePreload(() => import("./AttendanceTab-B1vAJLaK.js"), true ? __vite__mapDeps([15,1,2,16,17]) : void 0).then((module) => ({ default: module.AttendanceTab })));
const BillingTab = reactExports.lazy(() => __vitePreload(() => import("./BillingTab-CU47MQdQ.js"), true ? __vite__mapDeps([18,1,2,19,20,21]) : void 0).then((module) => ({ default: module.BillingTab })));
