import { s as createLucideIcon, b as useAuth, a as reactExports, e as useToast, ad as supabase, j as jsxRuntimeExports, m as motion, ae as Shield, X, U as Users, c as clsx, a3 as Activity, v as Search, f as RefreshCw, af as LoaderCircle, A as AnimatePresence, W as CircleCheckBig, u as useTheme, S as Settings$1, o as User, F as FileText, g as ChevronRight, ag as Sun, ah as Moon, n as BookOpen, G as GraduationCap, i as Sparkles, B as Bell, R as React, q as TriangleAlert, ai as RotateCcw, Z as Zap, aj as exportDataAsCSV, ak as exportFullBackup, al as importFullBackup, am as resetData } from "./index-CTZ1eQC9.js";
import { P as PageHeader } from "./PageHeader-D8byMYqA.js";
import { f as fetchProfile, U as UserAvatar, P as Palette, u as uploadProfileAvatar, r as removeProfileAvatar, a as updateProfile } from "./profileService-B0bElmKx.js";
import { u as useLocalStorage } from "./useLocalStorage-CBZXsDJG.js";
import { notificationService } from "./notificationService-BcAepVLD.js";
import { C as Camera } from "./camera--fvz1ABz.js";
import { P as Phone } from "./phone-BjaBqTx6.js";
import { B as Building2, S as School } from "./school-BfWEIvcb.js";
import { S as Save } from "./save-DCsHzsxU.js";
import { C as Check } from "./check-xK_n72vm.js";
import { B as Briefcase } from "./briefcase-DWCBIy7A.js";
import { P as Plus } from "./plus-D3yFq6RD.js";
import { E as Eye } from "./eye-uBbNlvRc.js";
import { F as FileDown } from "./file-down-CVvw04ZT.js";
import { D as Download } from "./download-BotpE1Pa.js";
import { U as Upload } from "./cloudStorageService-CuUrox-L.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto pb-24 space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "glass-panel rounded-3xl overflow-hidden animate-fade-in", custom: 2.5, initial: "hidden", animate: "visible", variants: cardVariant, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-5 pt-1 space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pb-4 border-b border-[var(--md-sys-color-outline-variant)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-black text-[var(--md-sys-color-primary)] uppercase tracking-widest block px-1", children: "Curriculum Standard" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2", children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                onClick: () => {
                  setPreference("selectedCurriculum", curr.id);
                ...
                className: clsx(
                  ...
                  isSelected ? "border-[var(--accent-primary)] bg-[var(--md-sys-color-primary-container)] text-[var(--md-sys-color-primary)] font-bold ring-1 ring-[var(--accent-primary)]" : "border-[var(--md-sys-color-outline-variant)] bg-[var(--md-sys-color-surface-variant)] text-[var(--md-sys-color-on-surface-variant)] hover:bg-[var(--md-sys-color-surface-1)]"
                ),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold font-google", children: curr.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] mt-0.5 opacity-80", children: curr.desc })
                ]
              },
              curr.id
            );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3", children: [
            ...
            { id: "nita", label: "Industrial Training (NITA)", desc: "Industrial Trades, Practical/Theory %, NITA/EPRA/National ID, Trade/Cohort terminology", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 20, className: "text-indigo-500" }) },
