const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/reportCardService-Hs7oI7Lz.js","assets/jspdf.es.min-mzyTBE0i.js","assets/index-CTZ1eQC9.js","assets/index-Dcw-JKvo.css"])))=>i.map(i=>d[i]);
import { s as createLucideIcon, u as useTheme, a as reactExports, e as useToast, j as jsxRuntimeExports, a6 as Award, h as CircleCheck, c as clsx, _ as __vitePreload, g as ChevronRight, G as GraduationCap, m as motion, n as BookOpen, A as AnimatePresence, X } from "./index-CTZ1eQC9.js";
              ...
              "button",
              {
                onClick: async () => {
                  const { generateBulkReportCards } = await __vitePreload(async () => {
                    const { generateBulkReportCards: generateBulkReportCards2 } = await import("./reportCardService-Hs7oI7Lz.js");
              ...
              "button",
              {
                onClick: async () => {
                  const { generateReportCard } = await __vitePreload(async () => {
                    const { generateReportCard: generateReportCard2 } = await import("./reportCardService-Hs7oI7Lz.js");
