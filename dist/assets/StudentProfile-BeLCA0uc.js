const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StudentList-CQNqSIrE.js","assets/index-CWZOk6sM.js","assets/index-DDAnmZh1.css","assets/subjectUtils-CWZOIqn8.js","assets/phone-BblhE0EH.js","assets/ProfileHeader-DUhwNAUv.js","assets/educationLevels-CWONNkiO.js","assets/notificationService-DzXbje6V.js","assets/bell-DPngBihw.js","assets/pen-line-wkvB9D2Z.js","assets/trash-2-BMugAsIw.js","assets/trending-down-C5NdZxUr.js","assets/OverviewTab-WxJfmPGq.js","assets/map-pin-VVi2kWKK.js","assets/AnalyticsTab-2bdLBG82.js","assets/AttendanceTab-gpSHiXZc.js","assets/plus-CAiaV-Kd.js","assets/circle-alert-CIuELtRP.js","assets/BillingTab-Djg48rl_.js","assets/credit-card-D3esSlKJ.js","assets/smartphone-DKnmPVXe.js","assets/history-TgX423QL.js"])))=>i.map(i=>d[i]);
import { a as reactExports, e as useToast, R as React, j as jsxRuntimeExports, P as PageTransition, G as GraduationCap, c as clsx, n as User, B as BookOpen, F as FileText, T as TriangleAlert, _ as __vitePreload } from "./index-CWZOk6sM.js";
import { A as AddStudentModal, E as EditStudentModal } from "./AddStudentModal-DKe1JYzl.js";
import { P as Plus } from "./plus-CAiaV-Kd.js";
import { A as ArrowLeft } from "./arrow-left-C6X_XPxr.js";
import { C as CreditCard } from "./credit-card-D3esSlKJ.js";
import "./educationLevels-CWONNkiO.js";
import "./circle-alert-CIuELtRP.js";
import "./camera-BE23yLZy.js";
import "./save-egituPWj.js";
const StudentList = reactExports.lazy(() => __vitePreload(() => import("./StudentList-CQNqSIrE.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0).then((module) => ({ default: module.StudentList })));
const ProfileHeader = reactExports.lazy(() => __vitePreload(() => import("./ProfileHeader-DUhwNAUv.js"), true ? __vite__mapDeps([5,1,2,6,7,8,3,9,10,11]) : void 0).then((module) => ({ default: module.ProfileHeader })));
const OverviewTab = reactExports.lazy(() => __vitePreload(() => import("./OverviewTab-WxJfmPGq.js"), true ? __vite__mapDeps([12,1,2,4,13]) : void 0).then((module) => ({ default: module.OverviewTab })));
const AnalyticsTab = reactExports.lazy(() => __vitePreload(() => import("./AnalyticsTab-2bdLBG82.js"), true ? __vite__mapDeps([14,1,2]) : void 0).then((module) => ({ default: module.AnalyticsTab })));
const AttendanceTab = reactExports.lazy(() => __vitePreload(() => import("./AttendanceTab-gpSHiXZc.js"), true ? __vite__mapDeps([15,1,2,16,17]) : void 0).then((module) => ({ default: module.AttendanceTab })));
const BillingTab = reactExports.lazy(() => __vitePreload(() => import("./BillingTab-Djg48rl_.js"), true ? __vite__mapDeps([18,1,2,19,20,21]) : void 0).then((module) => ({ default: module.BillingTab })));
