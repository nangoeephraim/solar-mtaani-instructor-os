const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/reportCardService-eHPII5FG.js","assets/jspdf.es.min-Cx_Gd2mi.js","assets/index-Dt5N_hgV.js","assets/index-C4y5DRbr.css"])))=>i.map(i=>d[i]);
import { o as createLucideIcon, u as useTheme, a as reactExports, e as useToast, j as jsxRuntimeExports, a3 as Award, h as CircleCheck, c as clsx, _ as __vitePreload, g as ChevronRight, G as GraduationCap, m as motion, B as BookOpen, A as AnimatePresence, X } from "./index-Dt5N_hgV.js";
import { a as getDefaultLevel, g as getStudentGroups, c as getLevelsForGroup } from "./educationLevels-X5jx7clp.js";
...
import { C as CircleAlert } from "./circle-alert-BAyhKf4O.js";
              ...
              "button",
              {
                onClick: async () => {
                  const { generateBulkReportCards } = await __vitePreload(async () => {
                    const { generateBulkReportCards: generateBulkReportCards2 } = await import("./reportCardService-eHPII5FG.js");
              ...
              "button",
              {
                onClick: async () => {
                  const { generateReportCard } = await __vitePreload(async () => {
                    const { generateReportCard: generateReportCard2 } = await import("./reportCardService-eHPII5FG.js");
