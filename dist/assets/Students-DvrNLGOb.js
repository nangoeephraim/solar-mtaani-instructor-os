import { o as createLucideIcon, a as reactExports, j as jsxRuntimeExports, d as useToast, u as useAuth, m as motion, U as Users, l as UserPlus, p as Search, Z as Zap, M as Monitor, c as clsx, B as BookOpen, G as GraduationCap, q as Grid3x3, A as AnimatePresence, f as ChevronRight, X, s as Mail, C as Calendar, n as User, t as ChartColumn } from "./index-l2RTGEA9.js";
import { g as getLevelShortLabel, b as getLevelsForGroup } from "./educationLevels-CHjJC3HX.js";
import { P as PageHeader } from "./PageHeader-BNW_nxzr.js";
import { E as EditStudentModal } from "./EditStudentModal-DTzr_TUC.js";
import { B as Building2 } from "./building-2-DgXMVJv2.js";
import { P as Phone } from "./phone-CqfxTuVm.js";
import { M as MapPin } from "./map-pin-8netVHeZ.js";
import { P as PenLine } from "./pen-line-H3epL2V1.js";
import { T as Trash2 } from "./trash-2-Yv5HQ1Ge.js";
import "./circle-alert-CMgkxloe.js";
import "./camera-BDD2Ner5.js";
import "./save-CIv_kv6h.js";
/**
...
const Students = ({
  ...
  const filteredStudents = data.students.filter((s) => {
    var _a;
    const matchesSearch = s.name.toLowerCase().includes(searchTerm.toLowerCase()) || s.lot.includes(searchTerm) || ((_a = s.email) == null ? void 0 : _a.toLowerCase().includes(searchTerm.toLowerCase()));
  ...
  const [newStudent, setNewStudent] = reactExports.useState({
    name: "",
    grade: "L3",
    lot: "",
    subject: "Solar",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col h-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-panel p-3 sm:p-4 mb-6 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 items-stretch sm:items-center justify-between bg-[var(--md-sys-color-surface)]/80 backdrop-blur-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto overflow-visible", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)]/60 rounded-lg p-1 border border-[var(--md-sys-color-outline)] overflow-x-auto custom-scrollbar flex-shrink-0", children: ["All", "Solar", "ICT"].map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                sub === "Solar" && /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 12 }),
                sub === "ICT" && /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { size: 12 }),
                sub
              ]
            },
            sub
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-[var(--md-sys-color-surface-variant)]/60 rounded-lg p-1 border border-[var(--md-sys-color-outline)] overflow-x-auto custom-scrollbar flex-shrink-0", children: ["All", "Campus", "Academy", "CBC", "High School"].map((grp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
            ...
            motion.button,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto mb-4", children: [
                  ...
                  ), children: student.subject === "Solar" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 12 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { size: 12 }) })
                ] }),
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 bg-gradient-to-br from-white/40 to-white/10 dark:from-slate-900/60 dark:to-slate-900/20 border-b border-[var(--md-sys-color-outline)] relative overflow-hidden group", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 p-4 opacity-5 pointer-events-none transition-transform group-hover:scale-110 duration-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 140 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => setSelectedStudent(null),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center relative z-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6 w-full border-b border-dashed border-gray-300 dark:border-gray-700 pb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-bold tracking-widest text-[var(--md-sys-color-secondary)] uppercase", children: "PRISM Technical Institute" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center sm:items-start gap-6 w-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 text-center space-y-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: clsx(
                        ...
                        selectedStudent.subject === "Solar" ? "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-800" : "bg-sky-50 text-sky-700 border-sky-200 dark:bg-sky-900/30 dark:text-sky-400 dark:border-sky-800"
                      ), children: selectedStudent.subject }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: clsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-3 pt-1", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-4 gap-y-2 text-xs", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[9px] text-[var(--md-sys-color-outline)] uppercase", children: "Cohort" }),
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 bg-gradient-to-r from-blue-600 to-indigo-600 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 bg-white/20 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { size: 20, className: "text-white" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white", children: "Add New Student" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowAddModal(false), "aria-label": "Close modal", title: "Close modal", className: "p-2 hover:bg-white/10 rounded-lg transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 20, className: "text-white" }) })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4 overflow-y-auto bg-[var(--md-sys-color-surface)]/80 backdrop-blur-md", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "Full Name *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface-variant)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "Lot Number *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface-variant)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "Level" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface-variant)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "select",
                      {
                        ...
                        className: "w-full px-4 py-3 bg-transparent rounded-xl text-sm focus:outline-none text-[var(--md-sys-color-on-surface)]",
                        children: getLevelsForGroup(newStudent.studentGroup || "Academy").map((lvl) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: lvl.id, children: lvl.label }, lvl.id))
                      }
                    ) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "Subject" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-2", children: ["Solar", "ICT"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        className: clsx(
                          ...
                          newStudent.subject === s ? s === "Solar" ? "border-orange-500 bg-orange-50/15 dark:bg-orange-950/20 text-orange-700 dark:text-orange-400 shadow-sm" : "border-blue-500 bg-blue-50/15 dark:bg-blue-950/20 text-blue-700 dark:text-blue-400 shadow-sm" : "border-[var(--md-sys-color-outline)] hover:border-violet-200 text-[var(--md-sys-color-on-surface-variant)] bg-[var(--md-sys-color-surface-variant)]/40"
                        ),
                        children: [
                          s === "Solar" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 14 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { size: 14 }),
                          s
                        ]
                      },
                      s
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "Group *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface-variant)] mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        value: newStudent.studentGroup,
                        onChange: (e) => setNewStudent((prev) => ({ ...prev, studentGroup: e.target.value })),
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Campus", children: "Campus" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Academy", children: "Academy" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "CBC", children: "CBC" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "Email" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface-variant)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "email",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "Phone" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface-variant)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "tel",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-[var(--md-sys-color-surface-variant)]/50 rounded-xl border border-[var(--md-sys-color-outline)] space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-xs font-bold text-[var(--md-sys-color-primary)] uppercase flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 14 }),
                    " Official Registration"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "Admission No." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "NITA Reg No." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "EPRA License" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "select",
                        {
                          value: newStudent.epraLicenseStatus || "None",
                          onChange: (e) => setNewStudent((prev) => ({ ...prev, epraLicenseStatus: e.target.value })),
                          "aria-label": "EPRA License",
                          title: "EPRA License",
                          className: "w-full px-3 py-2 bg-transparent rounded-xl text-sm focus:outline-none text-[var(--md-sys-color-on-surface)]",
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "None", children: "None" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "T1", children: "PV T1" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "T2", children: "PV T2" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "T3", children: "PV T3" })
                          ]
                        }
                      ) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold text-[var(--md-sys-color-secondary)] uppercase", children: "KCSE Grade" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "input-glow rounded-xl border border-[var(--md-sys-color-outline)] transition-all bg-[var(--md-sys-color-surface)] mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 bg-[var(--md-sys-color-surface-variant)]/90 backdrop-blur-md border-t border-[var(--md-sys-color-outline)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
