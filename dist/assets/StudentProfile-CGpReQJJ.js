const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StudentList-1G9gDjax.js","assets/index-CTZ1eQC9.js","assets/index-Dcw-JKvo.css","assets/subjectUtils-CWZOIqn8.js","assets/phone-BjaBqTx6.js","assets/ProfileHeader-DaImhSGD.js","assets/educationLevels-CWONNkiO.js","assets/notificationService-BcAepVLD.js","assets/pen-line-78u3QdsD.js","assets/OverviewTab-DtzLJ8KB.js","assets/map-pin-BEkLhwxj.js","assets/AnalyticsTab-FQg8A987.js","assets/AttendanceTab-sbjgdrKy.js","assets/plus-D3yFq6RD.js","assets/circle-alert-Be-OeDUH.js","assets/BillingTab-An_rjmn5.js","assets/smartphone-BYkdpwqA.js","assets/history-Db95Zjgj.js"])))=>i.map(i=>d[i]);
import { a as reactExports, e as useToast, R as React, j as jsxRuntimeExports, P as PageTransition, G as GraduationCap, c as clsx, o as User, n as BookOpen, F as FileText, p as CreditCard, q as TriangleAlert, _ as __vitePreload } from "./index-CTZ1eQC9.js";
import { A as AddStudentModal, E as EditStudentModal } from "./AddStudentModal-C60HkeDg.js";
import { P as Plus } from "./plus-D3yFq6RD.js";
import { A as ArrowLeft } from "./arrow-left-D0sNgFWS.js";
import "./educationLevels-CWONNkiO.js";
import "./circle-alert-Be-OeDUH.js";
import "./camera--fvz1ABz.js";
import "./save-DCsHzsxU.js";
const StudentList = reactExports.lazy(() => __vitePreload(() => import("./StudentList-1G9gDjax.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0).then((module) => ({ default: module.StudentList })));
const ProfileHeader = reactExports.lazy(() => __vitePreload(() => import("./ProfileHeader-DaImhSGD.js"), true ? __vite__mapDeps([5,1,2,6,7,3,8]) : void 0).then((module) => ({ default: module.ProfileHeader })));
const OverviewTab = reactExports.lazy(() => __vitePreload(() => import("./OverviewTab-DtzLJ8KB.js"), true ? __vite__mapDeps([9,1,2,4,10]) : void 0).then((module) => ({ default: module.OverviewTab })));
const AnalyticsTab = reactExports.lazy(() => __vitePreload(() => import("./AnalyticsTab-FQg8A987.js"), true ? __vite__mapDeps([11,1,2]) : void 0).then((module) => ({ default: module.AnalyticsTab })));
const AttendanceTab = reactExports.lazy(() => __vitePreload(() => import("./AttendanceTab-sbjgdrKy.js"), true ? __vite__mapDeps([12,1,2,13,14]) : void 0).then((module) => ({ default: module.AttendanceTab })));
const BillingTab = reactExports.lazy(() => __vitePreload(() => import("./BillingTab-An_rjmn5.js"), true ? __vite__mapDeps([15,1,2,16,17]) : void 0).then((module) => ({ default: module.BillingTab })));
