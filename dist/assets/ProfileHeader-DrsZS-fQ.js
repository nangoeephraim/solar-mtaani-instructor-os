import { a as reactExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion, X, bK as Send, R as React, Z as Zap, M as Monitor, c as clsx, B as BookOpen, a1 as Award, C as Calendar, a5 as TrendingUp } from "./index-l2RTGEA9.js";
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: clsx(
                    ...
                    student.subject === "Solar" ? "bg-amber-100/50 text-amber-700 border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-800/50" : "bg-sky-100/50 text-sky-700 border-sky-200 dark:bg-sky-900/30 dark:text-sky-400 dark:border-sky-800/50"
                  ), children: [
