import { r as requireReactDom, a as reactExports, R as React, j as jsxRuntimeExports, c as clsx, u as useAuth, b as useGoogleLogin, d as useToast, P as PageTransition, C as Calendar, S as Settings, e as RefreshCw, Z as Zap, f as ChevronRight, g as CircleCheck, M as Monitor, U as Users, h as Sparkles, A as AnimatePresence, m as motion, i as CircleX, k as ArrowRight } from "./index-l2RTGEA9.js";
import { u as useLocalStorage } from "./useLocalStorage-Bf7QeJfL.js";
import { g as getLevelShortLabel, S as STUDENT_GROUPS, a as getDefaultLevel, b as getLevelsForGroup } from "./educationLevels-CHjJC3HX.js";
import { notificationService } from "./notificationService-BeqD9muY.js";
import { P as Plus } from "./plus-DtGTZnOX.js";
import { P as Printer } from "./printer-BiiObfDi.js";
...
import { B as Bell } from "./bell-uYPXG9t7.js";
import { C as Copy } from "./copy-zzzZzZSA.js";
...
const Schedule = ({ data, onUpdateSchedule, onUpdateStudent, onAddSlot, onEditSlot, onDeleteSlot, onResetSchedule, onNavigate }) => {
  ...
  const handleDragEnd = (event) => {
    ...
    if (!over) return;
    const activeSlot = (_a = active.data.current) == null ? void 0 : _a.slot;
  ...
  reactExports.useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if ((e.ctrlKey || e.metaKey) && e.key === "n") {
        e.preventDefault();
        if ((user == null ? void 0 : user.role) !== "viewer") setShowAddModal(true);
      }
    };
    window.addEventListener("keydown", handleKeyDown);
    return () => window.removeEventListener("keydown", handleKeyDown);
  }, [showAddModal, selectedSlot, confirmDialog.isOpen, user == null ? void 0 : user.role]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageTransition, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full pb-20 lg:pb-0 flex flex-col bg-[var(--md-sys-color-surface)] overflow-hidden font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 px-3 md:px-6 pt-3 md:pt-6 pb-2 md:pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center gap-2 md:gap-4 bg-[var(--md-sys-color-surface)] rounded-2xl md:rounded-3xl border border-[var(--md-sys-color-outline-variant)] shadow-sm p-3 md:p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 md:gap-4 flex-1 w-full", children: [
        ...
        isMobile && (user == null ? void 0 : user.role) !== "viewer" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowAddModal(true), "aria-label": "Add Class", className: "p-2.5 bg-[var(--md-sys-color-primary)] text-[var(--md-sys-color-on-primary)] rounded-xl shadow-md flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 20 }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 md:gap-3 w-full md:w-auto overflow-x-auto pb-1 md:pb-0 hide-scrollbar", children: [
        ...
        !isMobile && (user == null ? void 0 : user.role) !== "viewer" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setShowAddModal(true), className: "px-5 py-2.5 bg-[var(--md-sys-color-primary)] text-[var(--md-sys-color-on-primary)] rounded-xl text-sm font-bold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-2", children: [
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 flex flex-col", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start gap-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: clsx("font-bold text-sm leading-tight flex items-center gap-1.5 truncate", color.text), children: [
                              slot.subject === "Solar" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 14, fill: "currentColor" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { size: 14 }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["Solar", "ICT"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { "aria-pressed": newSlot.subject === s, onClick: () => setNewSlot({ ...newSlot, subject: s }), className: clsx("flex-1 py-3 rounded-2xl font-bold text-sm border transition-all focus-visible:ring-2 focus-visible:ring-violet-500", newSlot.subject === s ? "bg-violet-100 border-violet-300 text-violet-800 dark:bg-violet-900/30 dark:border-violet-600 dark:text-violet-300 shadow-sm" : "border-[var(--md-sys-color-outline-variant)] text-[var(--md-sys-color-secondary)] hover:bg-[var(--md-sys-color-surface-variant)]"), children: [
                      s === "Solar" ? "☀️ " : "💻 ",
                      " ",
                      s
                    ] }, s)) })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: STUDENT_GROUPS.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { "aria-pressed": newSlotGroup === g, onClick: () => {
                      setNewSlotGroup(g);
                      setNewSlot({ ...newSlot, grade: getDefaultLevel(g), studentGroup: g });
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-[11px] font-bold text-[var(--md-sys-color-secondary)] uppercase mb-2", children: "Level" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: getLevelsForGroup(newSlotGroup).map((lvl) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { "aria-pressed": newSlot.grade === lvl.id, onClick: () => setNewSlot({ ...newSlot, grade: lvl.id }), className: clsx("px-3 py-2.5 rounded-2xl font-bold text-sm border transition-all focus-visible:ring-2 focus-visible:ring-violet-500", newSlot.grade === lvl.id ? "bg-violet-100 border-violet-300 text-violet-800 dark:bg-violet-900/30 dark:border-violet-600 dark:text-violet-300 shadow-sm" : "border-[var(--md-sys-color-outline-variant)] text-[var(--md-sys-color-secondary)] hover:bg-[var(--md-sys-color-surface-variant)]"), children: lvl.shortLabel }, lvl.id)) })
                  ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["Solar", "ICT"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { "aria-pressed": editSlotData.subject === s, onClick: () => setEditSlotData({ ...editSlotData, subject: s }), className: clsx("flex-1 py-2.5 rounded-xl font-bold text-sm border transition-all", editSlotData.subject === s ? "bg-violet-100 border-violet-300 text-violet-800 dark:bg-violet-900/30 dark:border-violet-600 dark:text-violet-300" : "border-[var(--md-sys-color-outline-variant)] text-[var(--md-sys-color-secondary)] hover:bg-[var(--md-sys-color-surface-variant)]"), children: [
                        s === "Solar" ? "☀️ " : "💻 ",
                        " ",
                        s
                      ] }, s)) })
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: STUDENT_GROUPS.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          "aria-pressed": editSlotData.studentGroup === g,
                          onClick: () => setEditSlotData({ ...editSlotData, studentGroup: g, grade: getDefaultLevel(g) }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-[11px] font-bold text-[var(--md-sys-color-secondary)] uppercase mb-1.5", children: "Level" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: getLevelsForGroup(editSlotData.studentGroup || "Academy").map((lvl) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-google font-bold text-[var(--md-sys-color-on-surface)] flex items-center gap-2", children: [
                        selectedSlot.subject === "Solar" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 24, className: "text-orange-500" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { size: 24, className: "text-blue-500" }),
